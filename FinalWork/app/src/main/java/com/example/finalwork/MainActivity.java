...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_forget) {
            ...
            if (rb_password.isChecked()) {
                com.example.finalwork.bean.UserInfo info = mHelper.queryByPhone(et_phone.getText().toString());
    ...
    private void loginSuccess() {
        if (bRemember) {
            ...
            com.example.finalwork.bean.UserInfo info = new com.example.finalwork.bean.UserInfo();
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        ...
        if (v.getId() == R.id.et_password) {
            if (phone.length() > 0 && hasFocus) {
                com.example.finalwork.bean.UserInfo info = mHelper.queryByPhone(phone);
                if (info != null) {
