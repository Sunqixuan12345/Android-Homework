package com.example.homework0005;
...
import com.example.homework0005.Util.DateUtil;
import com.example.homework0005.Util.ViewUtil;
import com.example.homework0005.database.UserDBHelper;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人", "公司", "18990169 孙启璇"};
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_forget) {
            ...
            if (rb_password.isChecked()) {
                com.example.homework0005.bean.UserInfo info = mHelper.queryByPhone(et_phone.getText().toString());
    ...
    private void loginSuccess() {
        if (bRemember) {
            ...
            com.example.homework0005.bean.UserInfo info = new com.example.homework0005.bean.UserInfo();
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        ...
        if (v.getId() == R.id.et_password) {
            if (phone.length() > 0 && hasFocus) {
                com.example.homework0005.bean.UserInfo info = mHelper.queryByPhone(phone);
                if (info != null) {
